package com.chengke.chengkecrmbackend.modules.system.user.architecture;
...
/**
 * 固化用户模块 controller/application/domain/infrastructure 的依赖方向。
 */
...
class UserArchitectureTest {
    ...
    static final ArchRule CONTROLLER_MUST_NOT_USE_INFRASTRUCTURE =
            noClasses().that().resideInAPackage("..user.controller..")
